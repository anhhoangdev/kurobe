...
class QuestionService:
    ...
    async def get_question(self, question_id: UUID, user_id: UUID) -> Optional[QuestionResponse]:
    ...
    async def retry_question(self, question_id: UUID, user_id: UUID) -> Optional[QuestionResponse]:
