...
const taskConfigs: TaskConfig[] = [
  {
    ...
    status: 'completed',
    className: 'bg-muted border border border-gray-200 dark:border-gray-800 text-muted-foreground',
  },
  {
  ...
  },
  {
    ...
    status: 'processing',
    className: 'bg-accent border border border-gray-200 dark:border-gray-800 text-foreground',
  },
  {
    title: 'Data analyzed',
    icon: (
    ...
    status: 'pending',
    className: 'bg-muted/50 border border border-gray-200 dark:border-gray-800/50 text-muted-foreground/70',
  },
];
        ...
        {taskConfigs.map((task, index) => (
          <motion.div
            ...
            className={`flex items-center gap-3 p-3 rounded-lg transition-all duration-300 ${
              index <= currentTaskIndex ? task.className : 'bg-muted/30 border border border-gray-200 dark:border-gray-800/30 text-muted-foreground/50'
            }`}
          >
            {/* Status indicator */}
            <div className="flex-shrink-0">
              {index < currentTaskIndex ? (
                ...
                <div className="size-5 border-2 border border-gray-200 dark:border-gray-800 rounded-full" />
              )}
            </div>
