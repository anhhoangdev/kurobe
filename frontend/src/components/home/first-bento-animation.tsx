    ...
    >
      ...
      >
        <div className="flex items-end justify-end gap-3">
          ...
          <div className="flex items-center bg-background rounded-full w-fit border border border-gray-200 dark:border-gray-800 flex-shrink-0">
            <img
        ...
        <div className="flex items-start gap-2">
          <div className="flex items-center bg-background rounded-full size-10 flex-shrink-0 justify-center shadow-[0_0_10px_rgba(0,0,0,0.05)] border border border-gray-200 dark:border-gray-800">
            <img 
          ...
          <div className="relative">
            <AnimatePresence mode="wait">
              {!shouldAnimate ? (
                <motion.div
                  key="dots"
                  className="absolute left-0 top-0 bg-background p-4 rounded-2xl border border border-gray-200 dark:border-gray-800"
                  initial={{ opacity: 0, x: -20 }}
                  animate={{ opacity: 1, x: 0 }}
                  exit={{ opacity: 0, x: -10 }}
                  transition={{
                ...
                <motion.div
                  key="response"
                  layout
                  className="absolute left-0 top-0 md:min-w-[300px] min-w-[220px] p-4 bg-accent border border border-gray-200 dark:border-gray-800 rounded-xl shadow-[0_0_10px_rgba(0,0,0,0.05)]"
