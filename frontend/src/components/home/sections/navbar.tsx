      ...
      >
        <div
          className={cn(
            ...
            hasScrolled
              ? 'px-2 md:px-2 border border border-gray-200 dark:border-gray-800 backdrop-blur-lg bg-background/75'
          ...
          <div className="flex h-[56px] items-center p-2 md:p-4">
            ...
            <div className="flex items-center justify-end flex-shrink-0 w-auto md:w-[200px] ml-auto">
              <div className="flex flex-row items-center gap-2 md:gap-3 shrink-0">
                ...
                <ThemeToggle />
                <button
                  className="md:hidden border border border-gray-200 dark:border-gray-800 size-8 rounded-md cursor-pointer flex items-center justify-center"
      ...
      <AnimatePresence>
        {isDrawerOpen && (
          <>
            ...
            <motion.div
              className="fixed inset-x-0 w-[95%] mx-auto bottom-3 bg-background border border border-gray-200 dark:border-gray-800 p-4 rounded-xl shadow-lg"
              initial="hidden"
              animate="visible"
              exit="exit"
            ...
            >
              ...
              <div className="flex flex-col gap-4">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    onClick={toggleDrawer}
                    className="border border border-gray-200 dark:border-gray-800 rounded-md p-1 cursor-pointer"
                  >
                    <X className="size-5" />
                  </button>
                </div>
                ...
                <motion.ul
                  className="flex flex-col text-sm mb-4 border border border-gray-200 dark:border-gray-800 rounded-md"
                ...
                >
                  <AnimatePresence>
                    {siteConfig.nav.links.map((item) => (
                      <motion.li
                        key={item.id}
                        className="p-2.5 border-b border border-gray-200 dark:border-gray-800 last:border-b-0"
