    ...
    <section id="hero" className="w-full relative overflow-hidden">
      ...
      <div className="relative flex flex-col items-center w-full px-4 sm:px-6">
        ...
        <div className="relative z-10 pt-16 sm:pt-24 md:pt-32 mx-auto h-full w-full max-w-6xl flex flex-col items-center justify-center">
          {/* <p className="border border border-gray-200 dark:border-gray-800 bg-accent rounded-full text-sm h-8 px-3 flex items-center gap-2">
            {hero.badgeIcon}
            {hero.badge}
          </p> */}
          ...
          {/* <Link
            ...
            className="group border border border-gray-200 dark:border-gray-800/50 bg-background hover:bg-accent/20 hover:border-secondary/40 rounded-full text-sm h-8 px-3 flex items-center gap-2 transition-all duration-300 shadow-sm hover:shadow-md hover:scale-105 hover:-translate-y-0.5"
          >
            {hero.badgeIcon}
      ...
      <Dialog open={authDialogOpen} onOpenChange={setAuthDialogOpen}>
        ...
        <DialogContent className="sm:max-w-md rounded-xl bg-background border border border-gray-200 dark:border-gray-800">
          <DialogHeader>
          ...
          <div className="relative my-6">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border border-gray-200 dark:border-gray-800"></div>
            </div>
          ...
          <div className="space-y-4 pt-4">
            ...
            <Link
              ...
              className="flex h-12 items-center justify-center w-full text-center rounded-full border border border-gray-200 dark:border-gray-800 bg-background hover:bg-accent/20 transition-all"
              onClick={() => setAuthDialogOpen(false)}
            >
              Create new account
            </Link>
